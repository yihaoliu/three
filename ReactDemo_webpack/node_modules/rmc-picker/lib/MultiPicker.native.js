    ...
    render: function render() {
        ...
        var colElements = children.map(function (col, i) {
            return _react2["default"].createElement(
                ...
                _react2["default"].createElement(_Picker2["default"], _extends({ itemStyle: pickerItemStyle, disabled: disabled, pure: pure, selectedValue: selectedValue[i], onValueChange: _this.onValueChange.bind(_this, i) }, col.props))
            );
        });
        return _react2["default"].createElement(
            _reactNative.View,
