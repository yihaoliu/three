...
ToastContainer=function(_React$Component){(0,_inherits3["default"])(ToastContainer,_React$Component);
function ToastContainer(props){(0,_classCallCheck3["default"])(this,ToastContainer);var _this=(0,_possibleConstructorReturn3["default"])(this,
_React$Component.call(this,props));
_this.state={
fadeAnim:new _reactNative.Animated.Value(0)};return _this;

}ToastContainer.prototype.
componentDidMount=function componentDidMount(){var _this2=this;var _props=
this.props,onClose=_props.onClose,onAnimationEnd=_props.onAnimationEnd;
...
this.props,_props2$type=_props2.type,type=_props2$type===undefined?'':_props2$type,content=_props2.content,styles=_props2.styles,mask=_props2.mask;
var iconType={
...
return _react2["default"].createElement(_reactNative.View,{style:[styles.container],pointerEvents:mask?undefined:'box-none'},
_react2["default"].createElement(_reactNative.View,{style:[styles.innerContainer]},
_react2["default"].createElement(_reactNative.Animated.View,{style:{opacity:this.state.fadeAnim}},
_react2["default"].createElement(_reactNative.View,{style:[styles.innerWrap,iconDom?styles.iconToast:styles.textToast]},
iconDom,
_react2["default"].createElement(_reactNative.Text,{style:styles.content},content)))));




};return ToastContainer;}(_react2["default"].Component);exports["default"]=ToastContainer;
