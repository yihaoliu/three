...
Row=function(_React$Component){(0,_inherits3["default"])(Row,_React$Component);
function Row(){(0,_classCallCheck3["default"])(this,Row);var _this=(0,_possibleConstructorReturn3["default"])(this,
...
return _react2["default"].createElement(_reactNative.TouchableWithoutFeedback,{onPress:this.onClick},
...
};return Row;}(_react2["default"].Component);exports["default"]=

(0,_createReactClass2["default"])({
getInitialState:function getInitialState(){
return{
isRefreshing:false,
loaded:0,
rowData:Array.from(new Array(20)).map(function(_val,i){return{text:'Initial row '+i,clicks:0};})};
...
var rcEl=_react2["default"].createElement(_refreshControl2["default"],{refreshing:this.state.isRefreshing,onRefresh:this.onRefresh,tintColor:'#ff0000',title:'Loading...',titleColor:'#00ff00',colors:['#ff0000','#00ff00','#0000ff'],progressBackgroundColor:'#ffff00'});
return _react2["default"].createElement(_reactNative.ScrollView,{style:styles.scrollview,refreshControl:rcEl},
rows);
