...
var _index=require('./style/index');var _index2=_interopRequireDefault(_index);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj};}var __rest=undefined&&undefined.__rest||function(s,e){var t={};for(var p in s){if(Object.prototype.hasOwnProperty.call(s,p)&&e.indexOf(p)<0)t[p]=s[p];}if(s!=null&&typeof Object.getOwnPropertySymbols==="function")for(var i=0,p=Object.getOwnPropertySymbols(s);i<p.length;i++){if(e.indexOf(p[i])<0)t[p[i]]=s[p[i]];}return t;};var
Badge=function(_React$Component){(0,_inherits3["default"])(Badge,_React$Component);function Badge(){(0,_classCallCheck3["default"])(this,Badge);return(0,_possibleConstructorReturn3["default"])(this,_React$Component.apply(this,arguments));}Badge.prototype.
render=function render(){
var _a=this.props,styles=_a.styles,style=_a.style,children=_a.children,text=_a.text,size=_a.size,overflowCount=_a.overflowCount,dot=_a.dot,corner=_a.corner,restProps=__rest(_a,["styles","style","children","text","size","overflowCount","dot","corner"]);
...
var contentDom=!dot?_react2["default"].createElement(_reactNative.View,(0,_extends3["default"])({},restProps,{style:[styles[badgeCls],styles[''+badgeCls+size]]}),
_react2["default"].createElement(_reactNative.Text,{style:[styles.text]},text)):
_react2["default"].createElement(_reactNative.View,(0,_extends3["default"])({},restProps,{style:[styles.dot,styles['dotSize'+size]]}));
return _react2["default"].createElement(_reactNative.View,{style:[styles.wrap,style]},
_react2["default"].createElement(_reactNative.View,{style:[styles[badgeCls+'Wrap']]},
children,
