...
var height=void 0;var _this$props=
_this.props,autoHeight=_this$props.autoHeight,onChange=_this$props.onChange;
...
_this.state={
inputCount:0,
height:props.rows>1?6*props.rows*4:_default2["default"].list_item_height};return _this;

}TextAreaItem.prototype.
render=function render(){var _this2=this;var
inputCount=this.state.inputCount;var _props=
this.props,value=_props.value,defaultValue=_props.defaultValue,error=_props.error,clear=_props.clear,autoHeight=_props.autoHeight,last=_props.last,onErrorClick=_props.onErrorClick,styles=_props.styles,style=_props.style;
...
return _react2["default"].createElement(_reactNative.View,{style:[styles.container,containerStyle,style,{position:'relative'}]},
_react2["default"].createElement(_reactNative.TextInput,(0,_extends3["default"])({clearButtonMode:clear?'while-editing':'never',underlineColorAndroid:'transparent',style:[styles.input,textareaStyle,{height:Math.max(45,this.state.height)}]},restProps,valueProps,{onChange:function onChange(event){return _this2.onChange(event);},multiline:rows>1||autoHeight,numberOfLines:rows,maxLength:maxLength})),
error?_react2["default"].createElement(_reactNative.TouchableWithoutFeedback,{onPress:onErrorClick},
...
null,
rows>1&&count>0?_react2["default"].createElement(_reactNative.View,{style:[styles.count]},
...
autoHeight:false,
last:false,
styles:_index2["default"]};module.exports=exports['default'];